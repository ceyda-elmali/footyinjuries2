...
export default function PrimeiraLigaInjuries() {
  const [injuryMapView, setInjuryMapView] = useState<"type" | "severity">("type");

  const latestInjuries = [
    { name: "Gonçalo Ramos", team: "Benfica", injury: "Ankle Injury", severity: "Moderate", returnDate: "Dec 22, 2025", reportedDate: "Nov 26, 2025", initials: "GR" },
    { name: "Otávio", team: "Porto", injury: "Muscle Strain", severity: "Minor", returnDate: "Dec 18, 2025", reportedDate: "Nov 25, 2025", initials: "O" },
  ];

  const expectedComebacks = [
    { name: "Otávio", team: "Porto", impact: "High Impact", daysUntil: 5, returnDate: "Dec 18, 2025", initials: "O" },
    { name: "Gonçalo Ramos", team: "Benfica", impact: "High Impact", daysUntil: 9, returnDate: "Dec 22, 2025", initials: "GR" },
  ];

  const topInjuredPlayers = [
    { rank: 1, name: "Gonçalo Ramos", team: "Benfica", injury: "Ankle Injury", status: "Recovery", returnDate: "Dec 22, 2025", value: "€40M", initials: "GR" },
    { rank: 2, name: "Otávio", team: "Porto", injury: "Muscle Strain", status: "Recovery", returnDate: "Dec 18, 2025", value: "€25M", initials: "O" },
    { rank: 3, name: "Pedro Gonçalves", team: "Sporting CP", injury: "Hamstring", status: "In Treatment", returnDate: "Dec 20, 2025", value: "€35M", initials: "PG" },
    { rank: 4, name: "Rafa Silva", team: "Benfica", injury: "Thigh Injury", status: "Recovery", returnDate: "Dec 19, 2025", value: "€20M", initials: "RS" },
    { rank: 5, name: "Mehdi Taremi", team: "Porto", injury: "Knee Injury", status: "In Treatment", returnDate: "Jan 2026", value: "€18M", initials: "MT" },
  ];

  const injuryByType = [
    { type: "Hamstring Strain", count: 6, percentage: 27, color: "bg-red-500" },
    { type: "Knee Injury", count: 5, percentage: 23, color: "bg-orange-500" },
    { type: "Ankle Injury", count: 4, percentage: 18, color: "bg-yellow-500" },
    { type: "Muscle Fatigue", count: 4, percentage: 18, color: "bg-blue-500" },
    { type: "Thigh Injury", count: 2, percentage: 9, color: "bg-purple-500" },
    { type: "Other", count: 1, percentage: 5, color: "bg-gray-500" },
  ];

  const injuryBySeverity = [
    { severity: "Severe", count: 3, percentage: 14, color: "bg-red-500" },
    { severity: "Moderate", count: 12, percentage: 54, color: "bg-orange-500" },
    { severity: "Minor", count: 7, percentage: 32, color: "bg-yellow-500" },
  ];

  const leagueTable = [
    { rank: 1, team: "Benfica", logo: "⚽", injuries: 6, avgSeverity: "Moderate", avgDays: 18, keyInjured: "Gonçalo Ramos, Rafa Silva" },
    { rank: 2, team: "Porto", logo: "⚽", injuries: 5, avgSeverity: "Moderate", avgDays: 17, keyInjured: "Otávio, Mehdi Taremi" },
    { rank: 3, team: "Sporting CP", logo: "⚽", injuries: 4, avgSeverity: "Minor", avgDays: 14, keyInjured: "Pedro Gonçalves" },
    { rank: 4, team: "Braga", logo: "⚽", injuries: 3, avgSeverity: "Minor", avgDays: 12, keyInjured: "—" },
    { rank: 5, team: "Vitória Guimarães", logo: "⚽", injuries: 2, avgSeverity: "Minor", avgDays: 10, keyInjured: "—" },
    { rank: 6, team: "Boavista", logo: "⚽", injuries: 1, avgSeverity: "Minor", avgDays: 8, keyInjured: "—" },
    { rank: 7, team: "Gil Vicente", logo: "⚽", injuries: 1, avgSeverity: "Minor", avgDays: 7, keyInjured: "—" },
  ];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Header */}
      <section className="w-full bg-gradient-to-br from-green-600/20 via-background to-red-600/20 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-green-600 to-red-600 flex items-center justify-center text-5xl">
              🇵🇹
            </div>
            <div className="flex-1 text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold mb-2">Primeira Liga</h1>
              <p className="text-xl text-muted-foreground mb-4">Portugal</p>
      ...
      <section className="w-full py-12 bg-background">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8">Latest Injuries in Primeira Liga</h2>
            ...
            {latestInjuries.map((player, idx) => (
              <div key={idx} className="glass-card rounded-xl p-6 hover:scale-105 transition-transform">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-green-600 to-red-600 flex items-center justify-center font-bold">
                    {player.initials}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {expectedComebacks.map((player, idx) => (
              <div key={idx} className="glass-card rounded-xl p-6 text-center hover:scale-105 transition-transform border-t-4 border-accent">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-accent to-green-600 flex items-center justify-center font-bold text-lg mx-auto mb-4">
                  {player.initials}
                </div>
                    ...
                    <tr key={idx} className="border-b border-border hover:bg-card/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-green-600 to-red-600 flex items-center justify-center font-bold text-sm">
                            {player.initials}
                          </div>
      ...
      <section className="w-full py-12 bg-card/30">
        <div className="max-w-4xl mx-auto px-4">
          <div className="glass-card rounded-2xl p-8">
            <h2 className="text-3xl font-bold mb-6">Week 13 Primeira Liga Injury Report – Last Updated Nov 27, 2025</h2>
            <div className="prose prose-invert max-w-none space-y-4 text-foreground">
              <p className="leading-relaxed">
                The Primeira Liga enters Gameweek 13 with a manageable injury situation across the top clubs, though Benfica and Porto are dealing with key absences.
              </p>
              <p className="leading-relaxed">
                <span className="font-semibold">Benfica</span> are managing without Gonçalo Ramos and Rafa Silva. The young striker's ankle injury will keep him out until late December, while Silva is expected back sooner.
              </p>
              <p className="leading-relaxed">
                <span className="font-semibold">Porto</span> face their own challenges with Otávio and Mehdi Taremi both sidelined. Otávio should return this week, but Taremi's knee injury requires more time.
              </p>
              <p className="leading-relaxed">
                <span className="font-semibold">Sporting CP</span> have Pedro Gonçalves recovering from a hamstring issue. The Portuguese midfielder is crucial to their title challenge and should be back before Christmas.
              </p>
              <p className="leading-relaxed">
                Overall, the Primeira Liga has recorded 22 active injuries, lower than other major European leagues. The winter break will provide valuable recovery time.
              </p>
              <p className="leading-relaxed font-semibold">
                Stay updated with FootyInjuries.com for the latest Primeira Liga injury news and return dates.
              </p>
